...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    title: "Click Any Number",
    subtitle: "Step 3 of 7",
    body: "Each of those four stats expands into the underlying list — every active registrant, every foreign principal, every reportable contact, every political contribution behind the count. Each list has its own search box, so you can jump straight to a name instead of paging through everything.",
    view: { kind: "country", name: "CHINA", tab: "overview" },
  },
  {
    title: "The Network",
